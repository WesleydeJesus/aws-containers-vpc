...
resource "aws_nat_gateway" "nat_1a" {
  allocation_id = aws_eip.vpc_eid_1a.id
...
resource "aws_nat_gateway" "nat_1b" {
  allocation_id = aws_eip.vpc_eid_1b.id
...
resource "aws_nat_gateway" "nat_1c" {
  allocation_id = aws_eip.vpc_eid_1c.id
